...
metropolitan area in Colombia, show that motorized vehicles were responsible for 81 percent of PM2.5  emissions in 2015; trucks were responsible
 ...
 Management Plan set out a renewal program for freight vehicles to phase in ultra-low and zero-emission vehicles.</p></body>',1,TRUE),
...
at the national level. ICLEI will continue to facilitate the exchange between local, regional and national government representatives.</p></body>',3,TRUE),
...
around the world and a special Countdown film.</p></body>',4,TRUE),
...
<br>Why it matters: Avon’s dilemma is a prelude for countless towns and cities along America’s coast, which are increasingly being forced to raise taxes or borrow money to protect their homes, roads and schools. As seas keep rising, so will the cost of holding back the water.</br></body>',2,TRUE),
...
<br>There is also the question of whether humans, and Earth, could become dependent on geoengineering. These practices, if begun, could become virtually impossible to stop if emissions continue to rise. Doing so could cause temperatures to skyrocket, according to some researchers.</pr></body>',3,TRUE);
