...
<br>ICLEI is recognized by the Japanese Ministry of Environment as a leading partner in supporting the momentum of local governments. Japans 
commitment to net zero must be followed by concrete measures to cut emissions, but it represents already represents a success for the local 
authorities across Japan that have been working to see their motivation and commitment to a net zero future be reflected in government action 
at the national level. ICLEI will continue to facilitate the exchange between local, regional and national government representatives.</p></body>',3,TRUE,null),
...
<br>Why it matters: Avon’s dilemma is a prelude for countless towns and cities along America’s coast, which are increasingly being forced to raise taxes or borrow money to protect their homes, roads and schools. As seas keep rising, so will the cost of holding back the water.</br></body>',2,TRUE,null),
(7,'Solar Geoengineering Should be Investigated','A controversial policy to address climate change by artificially cooling the planet deserves more research, according to a panel of leading U.S. scientists','<body><pr>But only if it is carefully governed.
...
<br>There is also the question of whether humans, and Earth, could become dependent on geoengineering. These practices, if begun, could become virtually impossible to stop if emissions continue to rise. Doing so could cause temperatures to skyrocket, according to some researchers.</pr></body>',3,TRUE,null);
...
INSERT INTO "comment" (user_id,post_id,body,isvisible) VALUES (5,3,'Very good post',TRUE), (9,3,'It is a great thing that climate change is being adressed',TRUE),(7,4,'Very good post',TRUE), (8,6,'It is a great thing that climate change is being adressed',TRUE);

INSERT INTO "comment" (user_id,post_id,body,comment_id,isvisible) VALUES (7,3,'Indeed',1,TRUE), (9,3,'It really is',2,TRUE);
