...
| US23       | Write Comments                              | high     | As an Writer,  I want to write comments, so that I can express my opinion regarding a post.                                                       |
| US24      | Reply to Comments                         | medium     | As Writer, I want to reply to comments, so that I can express my opinion regarding a comment. |
| US25      | Tag Post                      | medium     | As a Writer, I can tag my post, so that my post is related to a theme. |
| US26       | See Own Posts                     | medium     | As a Writer, I want to see all my written posts, so that I can review my older posts. |
...
| Identifier | Name  | Priority | Description  |
|------------|-----------------------|----------|-----------------------------------------------------------------------------------------------------------------------|
| US27       | Delete posts  | high     | As an Admin, I want to be able to delete posts that are against the platform rules, so that the platform is safe and free of unwanted posts.                               |
| US28       | Delete comments  | high     | As an Admin, I can delete comments, so that hateful comments can be deleted. |
| US29       | Delete accounts  | high     | As an Admin, I want to be able to delete accounts, so that I can take access from invalid users. |
| US30       | Block Accounts      | medium     | As an Admin, I want to be able to block accounts, so that I can keep users from accessing their account.  |
