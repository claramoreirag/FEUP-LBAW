                ...
                <div class="col-10">
                    <div class="row justify-content-between ">
                        ...
                        <div class="col-2 collapse navbar-collapse justify-content-end" id="navbarNav">
                            <a class="log nav-item nav-link " href="../pages/userManager.php"><i class="fas fa-users-cog"></i> </a>
                            <a class="log nav-item nav-link " href="../pages/adminDashboard.php"><i class="fas fa-exclamation-circle"></i> </a>
                            <a class="log nav-item nav-link d-none d-md-block" href="../pages/myProfilePage.php">Admin</a>
